...
export const InstructorForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <input type="text" placeholder="CI" value={instructor.ci}
                   onChange={(e) => setInstructor({ ...instructor, ci: e.target.value })} />
            <input type="text" placeholder="Nombre" value={instructor.nombre}
                   onChange={(e) => setInstructor({ ...instructor, nombre: e.target.value })} />
            <input type="text" placeholder="Apellido" value={instructor.apellido}
                   onChange={(e) => setInstructor({ ...instructor, apellido: e.target.value })} />
